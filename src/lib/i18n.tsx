...
const kk: Translations = {
  ...
  faq: [
    {
      q: 'Аннуитеттік төлем дифференциалды төлемнен чем айырмашылығы бар?',
    ...
    },
    {
      ...
      a: 'Ай сайын банк ағымдағы қарыз қалдығына пайыздарды есептейді: Қалдық × (Жылдық мөлшерлеме / 12). Мерзім басында қалдық ең үлкен, сондықтан пайыздар — төлемнің ең үлкен бөлігі. Дене өтелген сайын қалдық азаяды, пайыздық бөлік төмендейді.',
    },
    {
